...
//
// Solidity: function calc_token_amount(uint256[3] amounts, bool deposit) returns(uint256 out)
...
func (_Curve *CurveTransactor) RemoveLiquidityImbalance(opts *bind.TransactOpts, amounts [3]*big.Int, max_burn_amount *big.Int) (*types.Transaction, error) {
...
//
// Solidity: function remove_liquidity_imbalance(uint256[3] amounts, uint256 max_burn_amount) returns()
func (_Curve *CurveSession) RemoveLiquidityImbalance(amounts [3]*big.Int, max_burn_amount *big.Int) (*types.Transaction, error) {
...
//
// Solidity: function remove_liquidity_imbalance(uint256[3] amounts, uint256 max_burn_amount) returns()
func (_Curve *CurveTransactorSession) RemoveLiquidityImbalance(amounts [3]*big.Int, max_burn_amount *big.Int) (*types.Transaction, error) {
	return _Curve.Contract.RemoveLiquidityImbalance(&_Curve.TransactOpts, amounts, max_burn_amount)
}
